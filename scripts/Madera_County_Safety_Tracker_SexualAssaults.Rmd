...
sexassaults_county <- countywide_sexassault %>% filter(county=="Madera County")
```
...
There were <h8>`r prettyNum(sexassaults_county$total21,big.mark=",")`</h8> sexual assaults in 2021 across Madera County, according to data that law enforcement agencies report to the state of California.
