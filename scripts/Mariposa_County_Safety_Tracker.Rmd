...
There were <h8>`r prettyNum(murders_county$total22,big.mark=",")`</h8> homicides in 2022 across Mariposa County, according to data that law enforcement agencies report to the state of California.
...
murderpal2 <- colorBin(c("#76baf9",
                             ...
                             "#0058f6",
                             "#003ca6",
                             "#00215c"), valley_murder$`2022`, bins = murderbins2,na.color = "#76baf9")
