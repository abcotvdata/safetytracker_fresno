...
There were <h8>`r prettyNum(autothefts_county$total22,big.mark=",")`</h8> vehicle thefts in 2022 across Fresno County, according to data that law enforcement agencies report to the state of California.
...
autotheftpal2 <- colorBin(c("#76baf9",
                             ...
                             "#0058f6",
                             "#003ca6",
                             "#00215c"), valley_autotheft$`2022`, bins = autotheftbins2,na.color = "#51585f")

                            
# Create labels for vehicle thefts map
autotheftlabel_places <- paste(sep="",
                     "<popuptitle>",
                     valley_autotheft$`2022`,
                     ifelse(valley_autotheft$`2022`==1,
...
"</td>
				<td>",
valley_autotheft$rate22,
"</td>
			</tr>
						<tr>
				<td>3-year Average</td>
				<td>",
valley_autotheft$avg_prior4years,
"</td>
				<td>",
valley_autotheft$rate_prior4years,
"</td>
			</tr>
</table>",
