...
autothefts_county <- countywide_autotheft %>% filter(county=="Fresno County")
```
...
There were <h8>`r prettyNum(autothefts_county$total21,big.mark=",")`</h8> vehicle thefts in 2021 across Fresno County, according to data that law enforcement agencies report to the state of California.

In 2019, the data show that number was <h8>`r prettyNum(autothefts_county$total19,big.mark=",")`</h8>. In 2010, it was <h8>`r prettyNum(autothefts_county$total10,big.mark=",")`</h8>.

The risk is not the same in every community.

ABC30's data team looked at the data that every local police agency reported to the California Department of Justice each year through 2021, the latest date for which records are available. The vast majority of law enforcement agencies in the county do not make public more recent records.
...
<subhead>A closer look at vehicle thefts where you live</subhead>
...
# Set bins for numbers of crimes for vehicle thefts map
autotheftbins1 <- c(0,
                200,
                250,
                350,
...
autotheftbins2 <- c(0,
                ...
                300,
                4000)
autotheftpal1 <- colorBin(c("#76baf9",
                             "#2787d6",
                             "#0058f6",
                             "#003ca6",
                             "#00215c"), valley_autotheft$rate21, bins = autotheftbins1,na.color = "#76baf9")

autotheftpal2 <- colorBin(c("#76baf9",
                             "#2787d6",
                             "#0058f6",
                             "#003ca6",
                             "#00215c"), valley_autotheft$`2021`, bins = autotheftbins2,na.color = "#51585f")

                            
# Create labels for vehicle thefts map
autotheftlabel_places <- paste(sep="",
                     "<popuptitle>",
                     valley_autotheft$`2021`,
                     ifelse(valley_autotheft$`2021`==1,
                     " vehicle theft </popuptitle><br>",
                     " vehicle thefts </popuptitle><br>"),
                     " in 2021 in <b>",
                     ifelse(valley_autotheft$place %in% sheriffs,paste0("the combined unincorporated areas patrolled by the ",valley_autotheft$place),valley_autotheft$place),
                     "</b>, home to an estimated ",
                     prettyNum(valley_autotheft$population, big.mark=","),
                     " people.
<br>
<table>      
      <tr>
			...
			<tr>
				<td>2019</td>
				<td>",
prettyNum(valley_autotheft$`2019`, big.mark=","),
"</td>
				<td>",
valley_autotheft$rate19,
"</td>
			</tr>
			<tr>
				<td>2020</td>
				<td>",
prettyNum(valley_autotheft$`2020`, big.mark=","),
"</td>
				<td>",
valley_autotheft$rate20,
"</td>
			</tr>
						<tr>
				<td>2021</td>
...
"</td>
				<td>",
valley_autotheft$rate21,
"</td>
			</tr>
						<tr>
				<td>3-year Average</td>
				<td>",
valley_autotheft$avg_prior3years,
"</td>
				<td>",
valley_autotheft$rate_prior3years,
"</td>
			</tr>
</table>",
...
orange_autotheft_map <- leaflet(valley_autotheft, options = leafletOptions(zoomControl = FALSE, zoomSnap = 0.5, zoomDelta=0.5)) %>%
...
L.control.zoom({ position: 'topright' }).addTo(this)
  ...
  addLegend(opacity = 0.6,
            values = valley_autotheft$rate21, 
            pal = autotheftpal1,
            position = "bottomleft", 
            title = paste(sep="","<popuptitle>Vehicle Theft Rate<br><popupchatter>Vehicle Thefts/100K people<br>"),
            group = "Rate",
            className = "info legend Rate") %>%
  addLegend(opacity = 0.6,
            values = valley_autotheft$`2021`, 
            pal = autotheftpal2,
            position = "bottomleft", 
            title = paste(sep="","<popuptitle>Vehicle Thefts<br>"),
            group = "Number",
...
orange_autotheft_map
```
<br>
<br>
<!-- <subhead> Look up year by year city table-->
<iframe title="Vehicle thefts by community across the Central Valley" aria-label="Table" id="datawrapper-chart-Xfoys" src="https://datawrapper.dwcdn.net/Xfoys/2/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="1298" data-external="1"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(e){if(void 0!==e.data["datawrapper-height"]){var t=document.querySelectorAll("iframe");for(var a in e.data["datawrapper-height"])for(var r=0;r<t.length;r++){if(t[r].contentWindow===e.source)t[r].style.height=e.data["datawrapper-height"][a]+"px"}}}))}();</script>
<br>
<br>
<iframe title="2021 property crime rate comparison in select major cities" aria-label="Bar Chart" id="datawrapper-chart-e4AJd" src="https://datawrapper.dwcdn.net/e4AJd/1/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="580" data-external="1"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(e){if(void 0!==e.data["datawrapper-height"]){var t=document.querySelectorAll("iframe");for(var a in e.data["datawrapper-height"])for(var r=0;r<t.length;r++){if(t[r].contentWindow===e.source)t[r].style.height=e.data["datawrapper-height"][a]+"px"}}}))}();
</script>
