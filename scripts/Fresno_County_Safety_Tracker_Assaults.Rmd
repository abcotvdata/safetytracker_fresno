...
There were <h8>`r prettyNum(assaults_county$total21,big.mark=",")`</h8> aggravated assaults in 2021 across Fresno County, according to data that law enforcement agencies report to the state of California.
...
<subhead>A closer look at Fresno County assaults where you live</subhead>
...
assaultpal2 <- colorBin(c("#76baf9",
                             ...
                             "#0058f6",
                             "#003ca6",
                             "#00215c"), valley_assault$`2021`, bins = assaultbins2,na.color = "#51585f")
...
"</td>
				...
				<td>",
valley_assault$avg_prior3years,
"</td>
				<td>",
valley_assault$rate_prior3years,
"</td>
			</tr>
</table>",
...
<iframe title="Aggravated assaults by area across Orange County (Copy)" aria-label="Table" id="datawrapper-chart-KV9ad" src="https://datawrapper.dwcdn.net/KV9ad/1/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="2121" data-external="1"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(e){if(void 0!==e.data["datawrapper-height"]){var t=document.querySelectorAll("iframe");for(var a in e.data["datawrapper-height"])for(var r=0;r<t.length;r++){if(t[r].contentWindow===e.source)t[r].style.height=e.data["datawrapper-height"][a]+"px"}}}))}();
</script>
<br>
<br>
