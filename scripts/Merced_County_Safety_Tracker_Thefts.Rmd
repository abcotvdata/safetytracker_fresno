...
thefts_county <- countywide_theft %>% filter(county=="Merced County")
```
...
There were <h8>`r prettyNum(thefts_county$total21,big.mark=",")`</h8> larceny thefts in 2021 across Merced County, according to data that law enforcement agencies report to the state of California.
