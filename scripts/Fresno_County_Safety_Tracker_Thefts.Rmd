...
thefts_county <- countywide_theft %>% filter(county=="Fresno County")
```
...
There were <h8>`r prettyNum(thefts_county$total21,big.mark=",")`</h8> larceny thefts in 2021 across Fresno County, according to data that law enforcement agencies report to the state of California.
...
<subhead>A closer look at larcenies where you live</subhead>
...
theftpal1 <- colorBin(c("#76baf9",
                             ...
                             "#0058f6",
                             "#003ca6",
                             "#00215c"), valley_theft$rate21, bins = theftbins1,na.color = "#76baf9")

theftpal2 <- colorBin(c("#76baf9",
                             "#2787d6",
                             "#0058f6",
                             "#003ca6",
                             "#00215c"), valley_theft$`2021`, bins = theftbins2,na.color = "#51585f")
...
theftlabel_places <- paste(sep="",
                     "<popuptitle>",
                     valley_theft$`2021`,
                     ifelse(valley_theft$`2021`==1,
                     " theft </popuptitle><br>",
                     " thefts </popuptitle><br>"),
                     " in 2021 in <b>",
                     ifelse(valley_theft$place %in% sheriffs,paste0("the combined unincorporated areas patrolled by the ",valley_theft$place),valley_theft$place),
                     "</b>, home to an estimated ",
                     prettyNum(valley_theft$population, big.mark=","),
                     " people.
<br>
<table>      
      <tr>
			...
			<tr>
				<td>2019</td>
				<td>",
prettyNum(valley_theft$`2019`, big.mark=","),
"</td>
				<td>",
valley_theft$rate19,
"</td>
			...
			<tr>
				<td>2020</td>
				<td>",
prettyNum(valley_theft$`2020`, big.mark=","),
"</td>
				<td>",
valley_theft$rate20,
"</td>
...
"</td>
				...
				<td>",
prettyNum(valley_theft$avg_prior3years, big.mark=","),
"</td>
				<td>",
valley_theft$rate_prior3years,
"</td>
			</tr>
</table>",
...
orange_theft_map <- leaflet(valley_theft, options = leafletOptions(zoomControl = FALSE, zoomSnap = 0.5, zoomDelta=0.5)) %>%
...
<iframe title="Larceny thefts by community across the Central Valley" aria-label="Table" id="datawrapper-chart-yXzwK" src="https://datawrapper.dwcdn.net/yXzwK/2/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="1298" data-external="1"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(e){if(void 0!==e.data["datawrapper-height"]){var t=document.querySelectorAll("iframe");for(var a in e.data["datawrapper-height"])for(var r=0;r<t.length;r++){if(t[r].contentWindow===e.source)t[r].style.height=e.data["datawrapper-height"][a]+"px"}}}))}();</script>
<br>
<br>
