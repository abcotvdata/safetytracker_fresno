...
robberies_county <- countywide_robbery %>% filter(county=="Mariposa County")
```
...
There were <h8>`r prettyNum(robberies_county$total21,big.mark=",")`</h8> robberies in 2021 across Mariposa County, according to data that law enforcement agencies report to the state of California.
