...
autothefts_county <- countywide_autotheft %>% filter(county=="Madera County")
```

<h2>ABC30 is tracking crime and safety in communities across Madera County. 
...
There were <h8>`r prettyNum(autothefts_county$total21,big.mark=",")`</h8> vehicle thefts in 2021 across Madera County, according to data that law enforcement agencies report to the state of California.
