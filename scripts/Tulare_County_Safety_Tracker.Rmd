...
murders_county <- countywide_murder %>% filter(county=="Tulare County")
```
...
There were <h8>`r prettyNum(murders_county$total21,big.mark=",")`</h8> homicides in 2021 across Tulare County, according to data that law enforcement agencies report to the state of California.
