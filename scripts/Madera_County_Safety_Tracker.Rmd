...
There were <h8>`r prettyNum(murders_county$total22,big.mark=",")`</h8> homicides in 2022 across Madera County, according to data that law enforcement agencies report to the state of California.
