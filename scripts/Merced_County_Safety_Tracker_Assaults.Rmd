...
assaults_county <- countywide_assault %>% filter(county=="Merced County")
```
...
There were <h8>`r prettyNum(assaults_county$total21,big.mark=",")`</h8> aggravated assaults in 2021 across Merced County, according to data that law enforcement agencies report to the state of California.
