...
burglaries_county <- countywide_burglary %>% filter(county=="Merced County")
```
...
There were <h8>`r prettyNum(burglaries_county$total21,big.mark=",")`</h8> burglaries in 2021 across Merced County, according to data that law enforcement agencies report to the state of California.
