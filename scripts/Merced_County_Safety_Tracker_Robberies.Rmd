...
There were <h8>`r prettyNum(robberies_county$total21,big.mark=",")`</h8> robberies in 2021 across Merced County, according to data that law enforcement agencies report to the state of California.
