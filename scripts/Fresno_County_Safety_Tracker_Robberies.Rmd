...
robberies_county <- countywide_robbery %>% filter(county=="Fresno County")
```
...
There were <h8>`r prettyNum(robberies_county$total21,big.mark=",")`</h8> robberies in 2021 across Fresno County, according to data that law enforcement agencies report to the state of California.
...
<subhead>A closer look at Fresno County robberies where you live</subhead>
...
robberypal2 <- colorBin(c("#76baf9",
                             ...
                             "#0058f6",
                             "#003ca6",
                             "#00215c"), valley_robbery$`2021`, bins = robberybins2,na.color = "#51585f")
...
"</td>
				...
				<td>",
valley_robbery$avg_prior3years,
"</td>
				<td>",
valley_robbery$rate_prior3years,
"</td>
			</tr>
</table>",
...
<iframe title="Robberies by area across Orange County (Copy)" aria-label="Table" id="datawrapper-chart-T2OOC" src="https://datawrapper.dwcdn.net/T2OOC/1/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="2113" data-external="1"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(e){if(void 0!==e.data["datawrapper-height"]){var t=document.querySelectorAll("iframe");for(var a in e.data["datawrapper-height"])for(var r=0;r<t.length;r++){if(t[r].contentWindow===e.source)t[r].style.height=e.data["datawrapper-height"][a]+"px"}}}))}();
</script>
<br>
<br>
