...
murders_county <- countywide_murder %>% filter(county=="Fresno County")
```

<h2>ABC30 is tracking crime and safety in communities in Fresno County and across the Central Valley. This safety tracker lets you look into how often major crimes happen where you live and to examine trends over time, according to data that local law enforcement agencies report to the state of California.
...
There were <h8>`r prettyNum(murders_county$total21,big.mark=",")`</h8> homicides in 2021 across Fresno County, according to data that law enforcement agencies report to the state of California.

In 2019, the data show that number was <h8>`r prettyNum(murders_county$total19,big.mark=",")`</h8>. In 2010, it was <h8>`r prettyNum(murders_county$total10,big.mark=",")`</h8>.
...
The totals here include murders, but not involuntary manslaughter or justifiable homicide.

<subhead>A closer look at homicides where you live</subhead>
...
murderbins2 <- c(0,
                ...
                50,
                100)
murderpal1 <- colorBin(c("#76baf9",
                             "#2787d6",
                             "#0058f6",
                             "#003ca6",
                             "#00215c"), valley_murder$rate21, bins = murderbins1,na.color = "#76baf9")

murderpal2 <- colorBin(c("#76baf9",
                             "#2787d6",
                             "#0058f6",
                             "#003ca6",
                             "#00215c"), valley_murder$`2021`, bins = murderbins2,na.color = "#76baf9")

                            
# Create labels for murders map
murderlabel_places <- paste(sep="",
                     "<popuptitle>",
                     valley_murder$`2021`,
                     ifelse(valley_murder$`2021`==1,
                     " homicide </popuptitle><br>",
                     " homicides </popuptitle><br>"),
                     " in 2021 in <b>",
                     ifelse(valley_murder$place %in% sheriffs,paste0("the combined unincorporated areas patrolled by the ",valley_murder$place),valley_murder$place),
                     "</b>, home to an estimated ",
                     prettyNum(valley_murder$population, big.mark=","),
                     " people.
<br>
<table>      
      <tr>
...
"</td>
				<td>",
valley_murder$rate21,
"</td>
			</tr>
						<tr>
				<td>3-year Average</td>
				<td>",
valley_murder$avg_prior3years,
"</td>
				<td>",
valley_murder$rate_prior3years,
"</td>
			</tr>
</table>",
...
fresno_murder_map <- leaflet(valley_murder, options = leafletOptions(zoomControl = FALSE, zoomSnap = 0.5, zoomDelta=0.5)) %>%
...
<iframe title="Homicides by community across the Central Valley" aria-label="Table" id="datawrapper-chart-jzeYR" src="https://datawrapper.dwcdn.net/jzeYR/2/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="1298" data-external="1"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(e){if(void 0!==e.data["datawrapper-height"]){var t=document.querySelectorAll("iframe");for(var a in e.data["datawrapper-height"])for(var r=0;r<t.length;r++){if(t[r].contentWindow===e.source)t[r].style.height=e.data["datawrapper-height"][a]+"px"}}}))}();</script>
<br>
<br>
<iframe title="2021 homicide rate comparison in select major cities" aria-label="Bar Chart" id="datawrapper-chart-eqbVV" src="https://datawrapper.dwcdn.net/eqbVV/1/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="580" data-external="1"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(e){if(void 0!==e.data["datawrapper-height"]){var t=document.querySelectorAll("iframe");for(var a in e.data["datawrapper-height"])for(var r=0;r<t.length;r++){if(t[r].contentWindow===e.source)t[r].style.height=e.data["datawrapper-height"][a]+"px"}}}))}();
</script>
