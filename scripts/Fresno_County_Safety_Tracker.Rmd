...
There were <h8>`r prettyNum(murders_county$total22,big.mark=",")`</h8> homicides in 2022 across Fresno County, according to data that law enforcement agencies report to the state of California.
...
"</td>
				<td>",
valley_murder$rate22,
"</td>
			</tr>
						<tr>
				<td>4-year Average</td>
				<td>",
valley_murder$avg_prior4years,
"</td>
				<td>",
valley_murder$rate_prior4years,
"</td>
			</tr>
</table>",
