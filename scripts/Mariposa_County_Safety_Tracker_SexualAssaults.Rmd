...
sexassaults_county <- countywide_sexassault %>% filter(county=="Mariposa County")
```
...
There were <h8>`r prettyNum(sexassaults_county$total21,big.mark=",")`</h8> sexual assaults in 2021 across Mariposa County, according to data that law enforcement agencies report to the state of California.
