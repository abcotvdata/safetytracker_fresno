...
autothefts_county <- countywide_autotheft %>% filter(county=="Tulare County")
```
...
There were <h8>`r prettyNum(autothefts_county$total21,big.mark=",")`</h8> vehicle thefts in 2021 across Tulare County, according to data that law enforcement agencies report to the state of California.
