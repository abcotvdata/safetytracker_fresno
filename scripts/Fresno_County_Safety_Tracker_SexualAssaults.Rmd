...
sexassaults_county <- countywide_sexassault %>% filter(county=="Fresno County")
```
...
There were <h8>`r prettyNum(sexassaults_county$total21,big.mark=",")`</h8> sexual assaults in 2021 across Fresno County, according to data that law enforcement agencies report to the state of California.
...
<subhead>A closer look at Fresno County sexual assaults where you live</subhead>
...
sexassaultpal2 <- colorBin(c("#76baf9",
                             ...
                             "#0058f6",
                             "#003ca6",
                             "#00215c"), valley_sexassault$`2021`, bins = sexassaultbins2,na.color = "#51585f")
...
sexassaultlabel_places <- paste(sep="",
                     ...
                     ifelse(valley_sexassault$`2021`==1,
...
"</td>
				...
				<td>",
valley_sexassault$avg_prior3years,
"</td>
				<td>",
valley_sexassault$rate_prior3years,
"</td>
			</tr>
</table>",
...
<iframe title="Sexual assaults by area across Orange County" aria-label="Table" id="datawrapper-chart-2hhk5" src="https://datawrapper.dwcdn.net/2hhk5/3/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="2113" data-external="1"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(e){if(void 0!==e.data["datawrapper-height"]){var t=document.querySelectorAll("iframe");for(var a in e.data["datawrapper-height"])for(var r=0;r<t.length;r++){if(t[r].contentWindow===e.source)t[r].style.height=e.data["datawrapper-height"][a]+"px"}}}))}();
</script>
<br>
<br>
