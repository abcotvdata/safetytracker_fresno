...
There were <h8>`r prettyNum(autothefts_county$total22,big.mark=",")`</h8> vehicle thefts in 2022 across Kings County, according to data that law enforcement agencies report to the state of California.
